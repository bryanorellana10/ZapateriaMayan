namespace CapaBaseDeDatos.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CapaBaseDeDatos.Data.Context>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = false;
            ContextKey = "CapaBaseDeDatos.Data.Context";
        }

        protected override void Seed(CapaBaseDeDatos.Data.Context context)
        {
            ...
            var admin1 = new User()
            {
                UserName = "admin@mayasistema.com",
                Name = "Administrador"
            };

            userManager.Create(admin1, "Guatemala1821");
